...
"""
Dosen't save username across this call. This is fine because we will probalby use 
cookies to save username. Will probably have to do something similar for the picture itself
because it dosent stay after navigating away from the feed page.
"""
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('home.html', filename=filename, username=username)
